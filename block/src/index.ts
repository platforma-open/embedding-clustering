...
import { platforma } from "@platforma-open/milaboratories.embedding-clustering.model";
import {
  InferOutputsType,
  InferDataType,
  InferHrefType,
...
export type EmbeddingClusteringBlockContract = BlockContract;
export type EmbeddingClusteringBlockOutputs  = BlockOutputs;
export type EmbeddingClusteringBlockData     = BlockData;
export const EmbeddingClusteringBlockPointer = BlockPointer;
